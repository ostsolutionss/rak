<div id="cart" class="btn-group btn-block">
         <div class="cart">
     <img src="catalog/view/theme/LouisLi/images/cart.png" alt="">
         </div>
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><span id="cart-total"><p><?php echo $text_items; ?></p></span></button>
